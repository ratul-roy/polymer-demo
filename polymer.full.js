...
//alert(JSON.stringify(prototype));

//if(prototype.is =="icon-toggle-demo")alert(JSON.stringify(prototype.properties));
...
_configure: function () {
	//alert(7);
	//alert(this);
	//this.prototype = Object.create(this.constructor.prototype);
	//alert(JSON.stringify(this.properties));
	//this.properties = 
	//alert(JSON.stringify(this.constructor.prototype.properties));
	//this.properties = {"isFav":{"value":true,"defined":true}};
